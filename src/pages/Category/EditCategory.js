...
import { GetSingleCategory, UpdateCategory } from './../../redux/actions/Category';
...
export default function EditCategory() {
    ...
    const handelSubmet = (e) => {
        ...
        // } else {
        //     dispatch(UpdateCategory(state, category._id))
        //     setError("")
        ...
        dispatch(UpdateCategory(formData, category._id))
        setError("");
        history.push(`/category`)
    }
